...
function AboutUs() {
  ...
  return (
    <div className=" h-[567px] relative mt-[100vh] " style={style}>
      ...
      <div className="text-[1.5rem] font-medium text-Primary bg-[#ffffff] w-56 h-20 p-6 rounded-lg absolute bottom-[10%] left-[10%]" >50+ Quick Food Recipes That Easy To Do!</div>
    </div>
  );
}
